<template>
  <CCard>
    <CCardHeader>
      <strong v-if="documentId">About document</strong>
       <strong v-else>Create document</strong>
    </CCardHeader>
    <CCardBody>
      <CForm>
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput
            :label="isIncome ? 'Date received' : 'Date issued'"
              type="date"
        ...
        <CRow class="form-group">
          ...
          <CCol sm="6">
            <CInput label="Date signed" type="date" :value.sync="document.sign_at" class="mb-0" />
          </CCol>
        </CRow>
      </CForm>
    </CCardBody>
