    ...
    <CCol col="12">
      <CCard>
        ...
        <CCardBody>
          ...
          >
            <template #title="{item}">
              <td>{{item.title ? item.title.name :'Undefined'}}</td>
            </template>
            <template #department="{item}">
              <td>{{item.department ? item.department.name :'Undefined'}}</td>
            </template>
          </CDataTable>
          <CPagination
            align="center"
    ...
    return {
      ...
      fields: [
       ...
       searchFields: [
         ...
         { value: "title.name", label: "Position" },
