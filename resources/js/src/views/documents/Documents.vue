  ...
  computed: {
    ...
    fields() {
      ...
      { key: "symbol", label: "Registration number" },
         ...
         {
           key: "effective_at",
           label: this.isDocumentsIncome ? "Date received" : "Date issued",
         },
       ];
     },
     searchFields() {
       return[
         ...
         { value: "sign_at", label: "Sign date" },
         { value: "publisher.name", label: "Publisher" },
         { value: "organizes.name", label: "Receiving Location" },
         { value: "linkTo.symbol", label: "Allowing incoming documents" },
